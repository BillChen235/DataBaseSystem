...
/*
Modify: jquery 1.9後取消 $.browser 需用 $.support 取代
        old code:$.browser.msie || $.browser.safari
        new code $.support.leadingWhitespace
*/
	...
	function Wysiwyg() {
		...
		this.controls = {
			...
			h1: {
				...
				visible: true,
				className: "h1",
				command: ($.support.leadingWhitespace) ? "FormatBlock" : "heading",
				"arguments": ($.support.leadingWhitespace) ? "<h1>" : "h1",
				tags: ["h1"],
				tooltip: "Header 1"
			},
			...
			h2: {
				...
				className: "h2",
				command: ($.support.leadingWhitespace)	? "FormatBlock" : "heading",
				"arguments": ($.support.leadingWhitespace) ? "<h2>" : "h2",
				tags: ["h2"],
				tooltip: "Header 2"
			},
			...
			h3: {
				...
				className: "h3",
				command: ($.support.leadingWhitespace) ? "FormatBlock" : "heading",
				"arguments": ($.support.leadingWhitespace) ? "<h3>" : "h3",
				tags: ["h3"],
				tooltip: "Header 3"
			},
			...
			paragraph: {
				...
				className: "paragraph",
				command: "FormatBlock",
				"arguments": ($.support.leadingWhitespace) ? "<p>" : "p",
				tags: ["p"],
				tooltip: "Paragraph"
			},
...
html: '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" style="margin:0"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body style="margin:0;">INITIAL_CONTENT</body></html>',
		...
		this.ui.grow = function () {
			var self = this.self,
				...
				innerHeight = !$.support.leadingWhitespace ? innerBody[0].scrollHeight : innerBody.height() + 2 + 20, // 2 - borders, 20 - to prevent content jumping on grow
            ...
            setInterval(function () {
                ...
                try {
                    ...
                    if (range) {
                        offset = {
                            range: range,
                            parent: !$.support.leadingWhitespace ? range.parentElement() : range.endContainer.parentNode,
                            width: (!$.support.leadingWhitespace ? range.boundingWidth : range.startOffset - range.endOffset) || 0
                        };
                    }
                }
                catch (e) {
		...
		this.insertHtml = function (szHTML) {
			...
			if (!$.support.leadingWhitespace) {
			    ...
			    if ($.support.leadingWhitespace) { // @link https://github.com/akzhan/jwysiwyg/issues/50
					if (1 === $(szHTML).length) {
