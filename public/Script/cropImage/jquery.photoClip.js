...
(function(root, factory) {
	...
	function photoClip(container, option) {
		var size = option.size,
			...
			view = option.view,
			ok = option.ok,
            RadiusAngle = option.RadiusAngle,
		...
		function init() {
			...
			var $clip_area = $("<div class='photo-clip-area'>").css({
				...
				"left": "50%",
				"top": "50%",
				"border-radius":RadiusAngle,  //圓形截圖區
				"border-color":"#000",  //圓形區的顏色
				"width": clipWidth,
				"height": clipHeight,
